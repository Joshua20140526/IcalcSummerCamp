...
def get_event():
    list_events = []
    with open("summer  camp lesson 5 events.py") as file:
        for line in file:
            line = line.rstrip("\n")
...
c.pack()
c.create_text(100, 50, fill = 'blue', text = 'Calender', font = 'Courier 35',anchor='w')
...
for event in events:
    ...
    display = "%s - %s"%(event_name,days_until)
    c.create_text(100,vertical_space,fill="green",text=display,font='Courier 26',anchor='w')
